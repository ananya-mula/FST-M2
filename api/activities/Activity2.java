...
public class Activity2 {
    ...
    public void addNewUserFromFile() throws IOException {
        ...
        response.then().body("message", equalTo("990991"));
    }
    ...
    public void getUserInfo() {
        ...
        Response response =
                given().contentType(ContentType.JSON) // Set headers
                        .pathParam("username", "ananyaTest") // Pass request body from file
        ...
        // Assertion
        response.then().body("id", equalTo(990991));
        response.then().body("username", equalTo("ananyaTest"));
    ...
    public void deleteUser() throws IOException {
        Response response =
                given().contentType(ContentType.JSON) // Set headers
                        .pathParam("username", "ananyaTest") // Add path parameter
                        .when().delete(ROOT_URI + "/{username}"); // Send POST request

        // Assertion
        response.then().body("code", equalTo(200));
        response.then().body("message", equalTo("ananyaTest"));
    }
}
